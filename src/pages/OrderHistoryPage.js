  ...
  return (
    <div class='border rounded-lg p-4 mb-6 shadow hover:shadow-lg transition-shadow duration-300'>
      ...
      <div class='flex justify-between items-center pt-4 border-t'>
        <span class='font-semibold'>Total: ${order.totalAmount.toFixed(2)}</span>
        <span class='text-sm font-medium py-1 px-3 rounded-full bg-green-100 text-green-800'>{order.status}</span>
      </div>
    </div>
  );
}
