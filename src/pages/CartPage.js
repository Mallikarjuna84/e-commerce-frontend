...
import { selectCartItems, selectCartTotalPrice, removeItem, updateQuantity } from '../store/cartSlice';
    ...
    <div class='container mx-auto p-4'>
      ...
      {cartItems.length === 0 ? (
        ...
        <div>
          ...
          {cartItems.map(item => (
            <div key={item.product._id} class='grid grid-cols-1 md:grid-cols-3 gap-6 items-center mb-6 border-b pb-4'>
              <div class='flex items-center col-span-2'>
                <img src={item.product.imageUrl || 'https://via.placeholder.com/80x80'} alt={item.product.name} class='w-20 h-20 object-cover rounded mr-4' />
                <div>
